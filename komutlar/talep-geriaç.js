...
exports.run = async(client, message, args) => {
    ...
    if(!args[0]){return message.reply("a+talep-geriaç @talep sahibi")}
    ...
    .setTitle("VoltranBilişim Hizmetleri Destek Geri Açma")
    .setThumbnail("https://cdn.discordapp.com/attachments/778633901232357394/810472529432543323/AtlasBilisim.png") 
    .setColor("RED")
    .setDescription(`**Talebi geri açmak istediğine eminmisin?**\n\
    ...
    **❌ => Onaylamıyorum**`)).then(msg => {
        ...
        m1e.on("collect", async reaction => {
            ...
            message.channel.send("Talep Başarıyla Geri Açıldı.")
        })
